...
function Apropos() {
    return (
        <div className="flex flex-col md:flex-row md:gap-16 justify-center items-center pt-20">
            ...
            <div className="flex flex-col space-y-6 pt-16 text-left mx-10 pb-20 text-secondary md:text-lg">
                <h2 className="font-black text-xl">À propos de moi</h2>
